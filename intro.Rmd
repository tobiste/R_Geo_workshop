...
- have fractal geometries (i.e. they cover various scales, e.g. from the microscale to the plate-scale or planet-scale),
- have (large) uncertainties and non-gaussian distributions,
- include strongly independent variables that have multidimensional (and non-linear) relationships,
