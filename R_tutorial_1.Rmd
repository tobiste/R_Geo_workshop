...
Spatial and spatio-temporal geostatistical modelling, prediction and simulation (e.g. krige, variograms)
...
- [`dplyr`]()   is a data wrangling package, offering a series of functions (all called
...
- [`sp`]() is a cornerstone of spatial analysis in **R**, as it brings a set of data classes
...
2005).
- [`magrittr`]() Its sole contribution is to provide piping functionality to **R**. The
