...
![Figure 1: Global compilation of stress data showing the direction of the maximum horizontal stress ($\sigma_{Hmax}$) from the WSM2016 database (Robinson projection). The orientation of σHmax with respect to focal earthquake mechanisms and the three Andersonian fault is shown. From Stephan et al. (2023).](C:/Users/tobis/Documents/GIT_repos/R_Geo_workshop/Orientation_analysis/Figure_13_stress_world.png)
